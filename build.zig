...
pub fn build(b: *std.Build) void {
    ...
    const negative_cases = [_]struct { file: []const u8, message: []const u8 }{
        ...
        .{ .file = "activity_duplicate_endpoints", .message = "ecl-native: resource endpoints belong to one activity" },
...
fn configureRuntime(
    ...
    const net = module.owner.createModule(.{
        .root_source_file = module.owner.path("extensions/net/net.zig"),
