# ecl walking skeleton

This repository now contains a small end-to-end interpreter for the language
specified by [DESIGN.md](DESIGN.md), [GRAMMAR.md](GRAMMAR.md), and
[VOCABULARY.md](VOCABULARY.md). It is a walking skeleton: the important runtime
boundaries are real, while the full v1 vocabulary and optimized storage are
still future work.
