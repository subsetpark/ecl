...
### carries the image its words were written in independently of any
### registration through which a call was resolved, so `within` reached through it owns no slot -- and in
