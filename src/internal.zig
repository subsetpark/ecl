//! First-party aggregation for the executable and build-only verification tools.
//!
...
pub const module_snapshot = @import("module_snapshot.zig");
...
pub const Filesystem = @import("session.zig").Filesystem;
