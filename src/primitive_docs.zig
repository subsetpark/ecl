...
const entries = [_]Metadata{
    ...
    .{ .name = "@module", .effect = "body -- module", .text = "Evaluate a module body in a fresh unit and return its definitions as an anonymous immutable module value." },
    ...
    .{ .name = "@defm", .effect = "body module-name --", .text = "Evaluate a module body and register the resulting module value under a name; exactly `@module` followed by `register`." },
