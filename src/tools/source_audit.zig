...
const source_groups = [_]SourceGroup{
    ...
    // owner.
    .{ .production = true, .files = &.{
        "scheduler.zig",     "scheduler_core.zig",  "external.zig",      "process_port.zig",    "console.zig",       "task_prims.zig",     "filesystem_port.zig", "directory_resource.zig", "package_authority.zig", "directory_order.zig",
        "net_port.zig",      "byte_ring.zig",       "port_transfer.zig", "port_controller.zig", "port_message.zig",  "port_failure.zig",   "port_builder.zig",    "port_bytes.zig",         "port_messages.zig",     "port_declarations.zig",
        "port_resource.zig", "module_bindings.zig", "port_endpoint.zig", "port_result.zig",     "port_exchange.zig", "port_operation.zig", "port_service.zig",    "port_factory.zig",       "process_adapter.zig",   "net_adapter.zig",
        "http_service.zig",
    }, .sources = &.{
        ...
        @embedFile("../package_authority.zig"), @embedFile("../directory_order.zig"),
...
const repository_verification_files = [_][]const u8{
    ...
    "test/native/negative/resource_operation_endpoint.zig",
    "test/native/negative/wrong_controller_direction.zig",
