...
const source_groups = [_]SourceGroup{
    ...
    .{ .production = true, .files = &.{
        ...
        "port_resource.zig", "builtin_port.zig",   "port_endpoint.zig", "port_result.zig",     "port_exchange.zig", "port_factory.zig", "process_factory.zig", "net_factory.zig",
    }, .sources = &.{
        ...
        @embedFile("../port_exchange.zig"),   @embedFile("../port_factory.zig"),
        @embedFile("../process_factory.zig"), @embedFile("../net_factory.zig"),
    } },
