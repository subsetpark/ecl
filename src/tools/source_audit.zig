...
const source_groups = [_]SourceGroup{
    ...
    // owner.
    .{ .production = true, .files = &.{
        "scheduler.zig",       "scheduler_core.zig", "external.zig",      "process_port.zig",    "console.zig",        "task_prims.zig",   "filesystem_port.zig", "directory_resource.zig", "directory_stage.zig", "package_authority.zig", "directory_order.zig",
