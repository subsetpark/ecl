...
test "every primitive exposes meaningful reflective documentation" {
    const names = [_][]const u8{
        ...
        "cons",        "compose",   "match?",   "type",     "parse",       "parse-int",
        "parse-float", "@attempt",  "raise",    "args",     "exit",        "dip",
        "call",        "if",        "while",    "times",    "cond",        "each",
        "zip-with",    "for",       "fold",     "scan",     "stencil",     "unfold",
        "infra",       "def",       "set",      "defp",     "setp",        "test",
        "tests",       "@test",     "unset",    "undef",    "doc",         "which",
        ...
        "cos",         "not",       "at",       "where",    "first-where", "in?",
        "raze",        "cat",       "take",     "drop",     "reverse",     "first",
        "rest",        "range",     "shape",    "len",      "flip",        "reshape",
        "cmp",         "grade",     "distinct", "group",    "put",         "update",
        "del",         "split",     "join",     "str",      "band",        "bor",
        "bxor",        "bsl",       "bsr",      "bnot",     "stack",
    };
