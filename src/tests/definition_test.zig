...
test "every primitive exposes meaningful reflective documentation" {
    const names = [_][]const u8{
        ...
        "set",      "defp",     "setp",        "test",      "tests",       "@test",
        "unset",    "undef",    "doc",         "which",     "see",         "@module",
        "@defm",    "register", "import",      "alias",     "words",       "load",
        ...
        "at",       "where",    "first-where", "in?",       "raze",        "cat",
        "take",     "drop",     "reverse",     "first",     "rest",        "range",
        "shape",    "len",      "flip",        "reshape",   "cmp",         "grade",
        "distinct", "group",    "put",         "update",    "del",         "split",
        "join",     "str",      "band",        "bor",       "bxor",        "bsl",
        "bsr",      "bnot",     "stack",
    };
