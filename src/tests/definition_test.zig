...
test "every primitive exposes meaningful reflective documentation" {
    const names = [_][]const u8{
        ...
        "for",       "fold",      "scan",       "infra",     "def",         "set",
        "defp",      "setp",      "body",       "doc",       "which",       "see",
        ...
        "not",       "at",        "where",      "in?",       "raze",        "cat",
        "take",      "drop",      "reverse",    "first",     "rest",        "range",
        "shape",     "len",       "flip",       "reshape",   "cmp",         "grade",
        "distinct",  "group",     "keys",       "vals",      "put",         "to-dict",
        "del",       "merge",     "has?",       "split",     "join",        "format",
        "band",      "bor",       "bxor",       "bsl",       "bsr",         "bnot",
        "rand-int",  "rand-ints", "rand-float", "entropy",
    };
