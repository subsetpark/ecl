...
the extension adapter translates ABI v6 calls into the same runtime interfaces
...
The current pre-release native ABI is version 6, with entry symbol
`ecl_module_abi_v6`. Native modules built for earlier versions must be rebuilt;
